;;;      constantly being modified by Mark Andrew
;;;      modified on Fri Oct  7 10:55:23 PDT 1994 by detlefs
...
;; Put the following into your .emacs (MWA)
...
(defconst m3::keyword-line-starters
  (concat
   ...
   "WITH\\|FOREACH\\b\\|DO\\|CASE\\|\\bOF\\b\\|TYPECASE\\|LOCK\\|CONST\\|FROM\\|"
   "REVEAL\\|METHODS\\|OVERRIDES\\|FOR\\b")) ;; more MWA modula meddling
...
(defconst m3::multi-keyword-line-prefix
  (concat
   ...
   "\\(WHILE\\|WITH\\|FOREACH\\b\\|FOR\\b\\|LOCK\\)[^\n]*DO" "\\|"
...
(defconst m3::statement-starters
  (concat
   ...
   "WITH\\b\\|FOREACH\\b\\|FOR\\b\\|CASE\\b\\|TYPECASE\\b\\|LOCK\\b")
  "These are the patterns that can start lines and change the indentation
of the following line.")
...
(defconst m3::end-matchers
  (concat
   ...
   "\\bIF\\b\\|\\bWHILE\\b\\|\\bWITH\\b\\|\\bFOREACH\\b\\|\\bFOR\\b\\|\\bCASE\\b\\|"
...
(defvar mwa-font-lock-keywords ;;; New keywords also highlighted MWA
  (eval-when-compile
    (list
     (cons (regexp-opt 
	    '("UNSAFE" "INTERFACE" "END" "MODULE" "EXPORTS" "GENERIC" "IMPORT" "FROM" "BEGIN" "CONST" "TYPE" 
	      "EXCEPTION" "VAR" "REVEAL" "AS" "PROCEDURE" "RAISES" "VALUE" "READONLY" "ANY" "CASE" "OF" "ELSE" 
	      "EXIT" "EVAL" "FOR" "TO" "BY" "DO" "IF" "THEN" "LOCK" "LOOP" "RAISE" "REPEAT" "UNTIL" "RETURN" 
	      "TYPECASE" "TRY" "EXCEPT" "FINALLY" "WHILE" "WITH" "ELSIF" "ARRAY" "BITS" "OBJECT" "METHODS" 
	      ...
	      "PYTHON" "READS" "WRITES" "LIST" "DICT" "FOREACH" "IMPLEMENTS" "PROTOCOL" "SYNCHRONOUS" "RESET" "CALL" 
              "SCALED" "ASSERT" "AFTER" "REPLY") 'words) 	   
...
\\{m3::mode-map}"
  ...
  (setq font-lock-defaults '(mwa-font-lock-keywords))
